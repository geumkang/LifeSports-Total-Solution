  ...
  <!--   <footer class="py-5">
    ...
    <div class="copyright-w3ls py-4">
        <div class="container">
            <div class="row">
                <!-- copyright -->
                <p class="col-lg-8 copy-right-grids text-wh text-lg-left text-center mt-lg-2">@2019 Social Sports. All
                    Rights Reserved | Design by
                    <a href="https://w3layouts.com/" target="_blank">W3layouts & Team 11</a>
                </p>
                <!-- //copyright -->
                <!-- social icons -->
                <!-- //social icons -->
